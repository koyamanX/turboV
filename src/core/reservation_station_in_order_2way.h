...
declare reservation_station_in_order_2way {
	...
	func_out dispatch0(dispatch0_Op, dispatch0_Dest, dispatch0_Vj, dispatch0_Vk, dispatch0_A);
	output dispatch1_Op[7];
	output dispatch1_Dest[ROB_TAG_SIZE];
	output dispatch1_Vj[32];
	output dispatch1_Vk[32];
	output dispatch1_A[32];
	func_out dispatch1(dispatch1_Op, dispatch1_Dest, dispatch1_Vj, dispatch1_Vk, dispatch1_A);
